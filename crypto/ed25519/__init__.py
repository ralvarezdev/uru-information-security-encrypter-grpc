...
# Load company's public key from PEM file
COMPANY_PUBLIC_KEY_FILENAME = "company_public_key.pem"
COMPANY_PUBLIC_KEY = load_public_key_from_file(os.path.join(BASE_DIR, COMPANY_PUBLIC_KEY_FILENAME))
